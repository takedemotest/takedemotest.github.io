...
import { EventEmitter as EventEmitter2, signal as signal2, Input, Output, Directive, NgModule } from "@angular/core";
...
var Dir = class _Dir {
    ...
    valueSignal = signal2("ltr", ...ngDevMode ? [{
            debugName: "valueSignal"
        }] : []);
    ngAfterContentInit() {
    ...
    static \u0275dir = /* @__PURE__ */ i02.\u0275\u0275defineDirective({
        ...
        hostBindings: function Dir_HostBindings(rf, ctx) {
            if (rf & 2) {
                i02.\u0275\u0275attribute("dir", ctx._rawDir);
            }
        },
        inputs: {
            dir: "dir"
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.\u0275setClassMetadata(Dir, [{
            type: Directive,
            args: [{
                    selector: "[dir]",
                    providers: [{
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.\u0275setClassMetadata(BidiModule, [{
            type: NgModule,
            args: [{
                    imports: [Dir],
                    exports: [Dir]
...
//# sourceMappingURL=chunk-WMKF3GAE.js.map
