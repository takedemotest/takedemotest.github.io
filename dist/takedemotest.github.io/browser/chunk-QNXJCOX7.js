import { BidiModule, Directionality } from "@nf-internal/chunk-WMKF3GAE";
...
import { Subject, of as of2, Observable, Subscription, animationFrameScheduler, asapScheduler, isObservable as isObservable2 } from "rxjs";
...
var CdkVirtualForOf = class _CdkVirtualForOf {
    ...
    _changeDataSource(oldDs, newDs) {
        ...
        this._needsUpdate = true;
        return newDs ? newDs.connect(this) : of2();
    }
    _updateContext() {
