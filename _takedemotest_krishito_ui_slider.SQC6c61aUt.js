...
import { EventEmitter as s, DOCUMENT as l } from "@angular/core";
var c = ["*"];
function a(n, p) { if (n & 1) {
...
var u = (() => { class n {
    ...
    isOpenChange = new s;
    closed = new s;
    constructor(t, i) { this.renderer = t, this.document = i; }
    toggleSliderDrawer() { this.isOpen = !this.isOpen, this.isOpenChange.emit(this.isOpen), this.isOpen ? this.renderer.setStyle(this.document.body, "overflow", "hidden") : (this.renderer.removeStyle(this.document.body, "overflow"), this.closed.emit()); }
    ngOnDestroy() { this.renderer.removeStyle(this.document.body, "overflow"); }
    static \u0275fac = function (i) { return new (i || n)(e.\u0275\u0275directiveInject(e.Renderer2), e.\u0275\u0275directiveInject(l)); };
    static \u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["slider-drawer"]], inputs: { position: "position", isOpen: "isOpen", width: "width", title: "title" }, outputs: { isOpenChange: "isOpenChange", closed: "closed" }, ngContentSelectors: c, decls: 1, vars: 1, consts: [["class", "slider-drawer", 3, "ngClass", "click", 4, "ngIf"], [1, "slider-drawer", 3, "click", "ngClass"], [1, "slider-drawer_content", 3, "click"], [1, "slider-drawer_header"], [1, "ui-close-x", 3, "click"], [1, "slider-drawer_body"]], template: function (i, r) { i & 1 && (e.\u0275\u0275projectionDef(), e.\u0275\u0275template(0, a, 9, 6, "div", 0)), i & 2 && e.\u0275\u0275property("ngIf", r.isOpen); }, dependencies: [d, o.NgClass, o.NgIf], styles: ["[_nghost-%COMP%]{position:fixed;z-index:1;right:0;left:auto;width:100%}.slider-drawer[_ngcontent-%COMP%]{position:fixed;width:100%;height:100vh;top:0;background:#000000a3;z-index:1;display:flex}.slider-drawer.left[_ngcontent-%COMP%]{justify-content:flex-start}.slider-drawer.right[_ngcontent-%COMP%]{justify-content:flex-end}.slider-drawer_content[_ngcontent-%COMP%]{background:var(--%NS%main-bg-color)}.slider-drawer_header[_ngcontent-%COMP%]{display:flex;justify-content:space-between;padding:15px;align-items:center;border-bottom:1px solid #e0e0e0}.slider-drawer_header[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%]{margin-bottom:0}.slider-drawer_body[_ngcontent-%COMP%]{height:calc(100vh - 100px);overflow:auto}"] });
} return n; })();
export { u as SliderDrawerComponent };
