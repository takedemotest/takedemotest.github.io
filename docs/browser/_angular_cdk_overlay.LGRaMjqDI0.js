import { d as Xt, f as A, g as Ft, i as w, m as It, n as Tt, o as Nt, p as Wt, q as Ht, r as G } from "@nf-internal/chunk-FURHGKGK";
import { a as ht } from "@nf-internal/chunk-RMOXI6XO";
import { a as H } from "@nf-internal/chunk-ZVGPI6ZI";
import { b as j, c as Lt, d as ct } from "@nf-internal/chunk-OJNEDTQ2";
import { a as _ } from "@nf-internal/chunk-JE6VEUSL";
import "@nf-internal/chunk-MQ6KVUBG";
import { k as Yt, lb as lt } from "@nf-internal/chunk-VJYBASWG";
import { a as z } from "@nf-internal/chunk-XID2BBVI";
import { a as Z } from "@nf-internal/chunk-RECHUXGF";
import { b as dt } from "@nf-internal/chunk-FVDLKYOC";
import { d as M } from "@nf-internal/chunk-ZGWTKG5Z";
import { a as B } from "@nf-internal/chunk-7RHXFCZM";
import { c as pt, f as ft, i as _t } from "@nf-internal/chunk-EAER6ZQJ";
import { a as D, b as at } from "@nf-internal/chunk-2NFLSA4Y";
import * as f from "@angular/core";
import { DOCUMENT as E, NgZone as P, inject as p, Injector as R, RendererFactory2 as Q, afterNextRender as ut, ElementRef as V, InjectionToken as tt, ApplicationRef as zt, Renderer2 as jt, ANIMATION_MODULE_TYPE as Zt, EnvironmentInjector as Gt, EventEmitter as S, TemplateRef as Kt, ViewContainerRef as $t, booleanAttribute as m } from "@angular/core";
import { Location as Ut } from "@angular/common";
import { Subject as O, Subscription as C } from "rxjs";
import { filter as qt, takeWhile as Jt } from "rxjs/operators";
var gt = dt();
function Ot(s) { return new Y(s.get(w), s.get(E)); }
var Y = class {
    _viewportRuler;
    ...
    enable() { if (this._canBeEnabled()) {
        ...
        this._previousScrollPosition = this._viewportRuler.getViewportScrollPosition(), this._previousHTMLStyles.left = t.style.left || "", this._previousHTMLStyles.top = t.style.top || "", t.style.left = _(-this._previousScrollPosition.left), t.style.top = _(-this._previousScrollPosition.top), t.classList.add("cdk-global-scrollblock"), this._isEnabled = !0;
    } }
    disable() { if (this._isEnabled) {
        ...
        this._isEnabled = !1, i.left = this._previousHTMLStyles.left, i.top = this._previousHTMLStyles.top, t.classList.remove("cdk-global-scrollblock"), gt && (i.scrollBehavior = o.scrollBehavior = "auto"), window.scroll(this._previousScrollPosition.left, this._previousScrollPosition.top), gt && (i.scrollBehavior = n, o.scrollBehavior = r);
    } }
...
function Ct(s, t) { return new L(s.get(A), s.get(P), s.get(w), t); }
var L = class {
    _scrollDispatcher;
    _ngZone;
    _viewportRuler;
...
function Qt() { return new k; }
var k = class {
    enable() { }
    disable() { }
    attach() { }
};
function K(s, t) { return t.some(e => { let i = s.bottom < e.top, o = s.top > e.bottom, n = s.right < e.left, r = s.left > e.right; return i || o || n || r; }); }
function yt(s, t) { return t.some(e => { let i = s.top < e.top, o = s.bottom > e.bottom, n = s.left < e.left, r = s.right > e.right; return i || o || n || r; }); }
function et(s, t) { return new X(s.get(A), s.get(w), s.get(P), t); }
var X = class {
    _scrollDispatcher;
    _viewportRuler;
    _ngZone;
    ...
    enable() { if (!this._scrollSubscription) {
        ...
        this._scrollSubscription = this._scrollDispatcher.scrolled(t).subscribe(() => { if (this._overlayRef.updatePosition(), this._config && this._config.autoClose) {
            ...
            K(e, [{ width: i, height: o, bottom: o, right: i, top: 0, left: 0 }]) && (this.disable(), this._ngZone.run(() => this._overlayRef.detach()));
        } });
    } }
    disable() { this._scrollSubscription && (this._scrollSubscription.unsubscribe(), this._scrollSubscription = null); }
    detach() { this.disable(), this._overlayRef = null; }
    ...
    constructor() { }
    noop = () => new k;
    close = e => Ct(this._injector, e);
    block = () => Ot(this._injector);
    reposition = e => et(this._injector, e);
...
function te(s, t) { if (t !== "top" && t !== "bottom" && t !== "center")
    throw Error(`ConnectedPosition: Invalid ${s} "${t}". Expected "top", "bottom" or "center".`); }
function ee(s, t) { if (t !== "start" && t !== "end" && t !== "center")
...
var Pt = (() => { class s {
    ...
    canReceiveEvent(e, i, o) { return o.observers.length < 1 ? !1 : e.eventPredicate ? e.eventPredicate(i) : !0; }
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275prov = f.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })(), xt = (() => { class s extends Pt {
    _ngZone = p(P);
    _renderer = p(Q).createRenderer(null, null);
    _cleanupKeydown;
    ...
    _keydownListener = e => { let i = this._attachedOverlays; for (let o = i.length - 1; o > -1; o--) {
        let n = i[o];
        if (this.canReceiveEvent(n, e, n._keydownEvents)) {
            this._ngZone.run(() => n._keydownEvents.next(e));
            break;
        }
    } };
    static \u0275fac = (() => { let e; return function (o) { return (e || (e = f.\u0275\u0275getInheritedFactory(s)))(o || s); }; })();
    static \u0275prov = f.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })(), Et = (() => { class s extends Pt {
    _platform = p(B);
    _ngZone = p(P);
    _renderer = p(Q).createRenderer(null, null);
    ...
    _clickListener = e => { let i = M(e), o = e.type === "click" && this._pointerDownEventTarget ? this._pointerDownEventTarget : i; this._pointerDownEventTarget = null; let n = this._attachedOverlays.slice(); for (let r = n.length - 1; r > -1; r--) {
        let a = n[r], h = a._outsidePointerEvents;
        if (!(!a.hasAttached() || !this.canReceiveEvent(a, e, h))) {
            if (vt(a.overlayElement, i) || vt(a.overlayElement, o))
                break;
...
function vt(s, t) { let e = typeof ShadowRoot < "u" && ShadowRoot, i = t; for (; i;) {
    if (i === s)
        return !0;
...
var Rt = (() => {
    class s {
        static \u0275fac = function (i) { return new (i || s); };
        static \u0275cmp = f.\u0275\u0275defineComponent({ type: s, selectors: [["ng-component"]], hostAttrs: ["cdk-overlay-style-loader", ""], decls: 0, vars: 0, template: function (i, o) { }, styles: [`.cdk-overlay-container, .cdk-global-overlay-wrapper {
  pointer-events: none;
  top: 0;
  left: 0;
  height: 100%;
...
function it(s) { return s && s.nodeType === 1; }
var I = class {
    _portalOutlet;
    _host;
    _pane;
    ...
    _afterNextRenderRef;
    constructor(t, e, i, o, n, r, a, h, d, l = !1, c, u) { this._portalOutlet = t, this._host = e, this._pane = i, this._config = o, this._ngZone = n, this._keyboardDispatcher = r, this._document = a, this._location = h, this._outsideClickDispatcher = d, this._animationsDisabled = l, this._injector = c, this._renderer = u, o.scrollStrategy && (this._scrollStrategy = o.scrollStrategy, this._scrollStrategy.attach(this)), this._positionStrategy = o.positionStrategy; }
    ...
    setDirection(t) { this._config = at(D({}, this._config), { direction: t }), this._updateElementDirection(); }
    ...
    _updateElementSize() { if (!this._pane)
        return; let t = this._pane.style; t.width = _(this._config.width), t.height = _(this._config.height), t.minWidth = _(this._config.minWidth), t.minHeight = _(this._config.minHeight), t.maxWidth = _(this._config.maxWidth), t.maxHeight = _(this._config.maxHeight); }
    ...
    _attachHost() { if (!this._host.parentElement) {
        ...
        it(t) ? t.after(this._host) : t?.type === "parent" ? t.element.appendChild(this._host) : this._previousHostParent?.appendChild(this._host);
    } if (this._config.usePopover)
        try {
            this._host.showPopover();
        }
        catch { } }
    _attachBackdrop() { let t = "cdk-overlay-backdrop-showing"; this._backdropRef?.dispose(), this._backdropRef = new q(this._document, this._renderer, this._ngZone, e => { this._backdropClick.next(e); }), this._animationsDisabled && this._backdropRef.element.classList.add("cdk-overlay-backdrop-noop-animation"), this._config.backdropClass && this._toggleClasses(this._backdropRef.element, this._config.backdropClass, !0), this._config.usePopover ? this._host.prepend(this._backdropRef.element) : this._host.parentElement.insertBefore(this._backdropRef.element, this._host), !this._animationsDisabled && typeof requestAnimationFrame < "u" ? this._ngZone.runOutsideAngular(() => { requestAnimationFrame(() => this._backdropRef?.element.classList.add(t)); }) : this._backdropRef.element.classList.add(t); }
    ...
    _detachContentWhenEmpty() { let t = !1; try {
        this._detachContentAfterRenderRef = ut(() => { t = !0, this._detachContent(); }, { injector: this._injector });
    }
    catch (e) {
        if (t)
            throw e;
...
}, mt = "cdk-overlay-connected-position-bounding-box", ie = /([A-Za-z%]+)$/;
function st(s, t) { return new T(t, s.get(w), s.get(E), s.get(B), s.get(W)); }
var T = class {
    _viewportRuler;
    _document;
    _platform;
    ...
    dispose() { this._isDisposed || (this._boundingBox && b(this._boundingBox.style, { top: "", left: "", right: "", bottom: "", height: "", width: "", alignItems: "", justifyContent: "" }), this._pane && this._resetOverlayElementStyles(), this._overlayRef && this._overlayRef.hostElement.classList.remove(mt), this.detach(), this._positionChanges.complete(), this._overlayRef = this._boundingBox = null, this._isDisposed = !0); }
    ...
    getPopoverInsertionPoint() { return this._popoverLocation === "global" ? null : this._popoverLocation !== "inline" ? this._popoverLocation : this._origin instanceof V ? this._origin.nativeElement : it(this._origin) ? this._origin : null; }
    ...
    _getOverlayFit(t, e, i, o) { let n = wt(e), { x: r, y: a } = t, h = this._getOffset(o, "x"), d = this._getOffset(o, "y"); h && (r += h), d && (a += d); let l = 0 - r, c = r + n.width - i.width, u = 0 - a, y = a + n.height - i.height, g = this._subtractOverflows(n.width, l, c), v = this._subtractOverflows(n.height, u, y), rt = g * v; return { visibleArea: rt, isCompletelyWithinViewport: n.width * n.height === rt, fitsInViewportVertically: v === n.height, fitsInViewportHorizontally: g == n.width }; }
    _canFitWithFlexibleDimensions(t, e, i) { if (this._hasFlexibleDimensions) {
        let o = i.bottom - e.y, n = i.right - e.x, r = bt(this._overlayRef.getConfig().minHeight), a = bt(this._overlayRef.getConfig().minWidth), h = t.fitsInViewportVertically || r != null && r <= o, d = t.fitsInViewportHorizontally || a != null && a <= n;
        return h && d;
    } return !1; }
    _pushOverlayOnScreen(t, e, i) { if (this._previousPushAmount && this._positionLocked)
        return { x: t.x + this._previousPushAmount.x, y: t.y + this._previousPushAmount.y }; let o = wt(e), n = this._viewportRect, r = Math.max(t.x + o.width - n.width, 0), a = Math.max(t.y + o.height - n.height, 0), h = Math.max(n.top - i.top - t.y, 0), d = Math.max(n.left - i.left - t.x, 0), l = 0, c = 0; return o.width <= n.width ? l = d || -r : l = t.x < this._getViewportMarginStart() ? n.left - i.left - t.x : 0, o.height <= n.height ? c = h || -a : c = t.y < this._getViewportMarginTop() ? n.top - i.top - t.y : 0, this._previousPushAmount = { x: l, y: c }, { x: t.x + l, y: t.y + c }; }
    _applyPosition(t, e) { if (this._setTransformOrigin(t), this._setOverlayElementStyles(e, t), this._setBoundingBoxStyles(e, t), t.panelClass && this._addPanelClasses(t.panelClass), this._positionChanges.observers.length) {
        ...
        if (t !== this._lastPosition || !this._lastScrollVisibility || !se(this._lastScrollVisibility, i)) {
            let o = new F(t, i);
    ...
    _calculateBoundingBoxRect(t, e) { let i = this._viewportRect, o = this._isRtl(), n, r, a; if (e.overlayY === "top")
        ...
        let y = Math.min(i.bottom - t.y + i.top, t.y), g = this._lastBoundingBoxSize.height;
        n = y * 2, r = t.y - y, n > g && !this._isInitialRender && !this._growAfterOpen && (r = t.y - g / 2);
    } let h = e.overlayX === "start" && !o || e.overlayX === "end" && o, d = e.overlayX === "end" && !o || e.overlayX === "start" && o, l, c, u; if (d)
        u = i.width - t.x + this._getViewportMarginStart() + this._getViewportMarginEnd(), l = t.x - this._getViewportMarginStart();
    else if (h)
        c = t.x, l = i.right - t.x - this._getViewportMarginEnd();
    else {
        let y = Math.min(i.right - t.x + i.left, t.x), g = this._lastBoundingBoxSize.width;
        l = y * 2, c = t.x - y, l > g && !this._isInitialRender && !this._growAfterOpen && (c = t.x - g / 2);
    } return { top: r, left: c, bottom: a, right: u, width: l, height: n }; }
    _setBoundingBoxStyles(t, e) { let i = this._calculateBoundingBoxRect(t, e); !this._isInitialRender && !this._growAfterOpen && (i.height = Math.min(i.height, this._lastBoundingBoxSize.height), i.width = Math.min(i.width, this._lastBoundingBoxSize.width)); let o = {}; if (this._hasExactPosition())
        ...
        o.width = _(i.width), o.height = _(i.height), o.top = _(i.top) || "auto", o.bottom = _(i.bottom) || "auto", o.left = _(i.left) || "auto", o.right = _(i.right) || "auto", e.overlayX === "center" ? o.alignItems = "center" : o.alignItems = e.overlayX === "end" ? "flex-end" : "flex-start", e.overlayY === "center" ? o.justifyContent = "center" : o.justifyContent = e.overlayY === "bottom" ? "flex-end" : "flex-start", n && (o.maxHeight = _(n)), r && (o.maxWidth = _(r));
    ...
    _setOverlayElementStyles(t, e) { let i = {}, o = this._hasExactPosition(), n = this._hasFlexibleDimensions, r = this._overlayRef.getConfig(); if (o) {
        ...
        i.position = "static"; let a = "", h = this._getOffset(e, "x"), d = this._getOffset(e, "y"); h && (a += `translateX(${h}px) `), d && (a += `translateY(${d}px)`), i.transform = a.trim(), r.maxHeight && (o ? i.maxHeight = _(r.maxHeight) : n && (i.maxHeight = "")), r.maxWidth && (o ? i.maxWidth = _(r.maxWidth) : n && (i.maxWidth = "")), b(this._pane.style, i); }
    ...
    _getExactOverlayX(t, e, i) { let o = { left: "", right: "" }, n = this._getOverlayPoint(e, this._overlayRect, t); this._isPushed && (n = this._pushOverlayOnScreen(n, this._overlayRect, i)); let r; if (this._isRtl() ? r = t.overlayX === "end" ? "left" : "right" : r = t.overlayX === "end" ? "right" : "left", r === "right") {
        ...
        o.left = _(n.x); return o; }
    _getScrollVisibility() { let t = this._getOriginRect(), e = this._pane.getBoundingClientRect(), i = this._scrollables.map(o => o.getElementRef().nativeElement.getBoundingClientRect()); return { isOriginClipped: yt(t, i), isOriginOutsideView: K(t, i), isOverlayClipped: yt(e, i), isOverlayOutsideView: K(e, i) }; }
    ...
    _getOriginRect() { let t = this._origin; if (t instanceof V)
...
function bt(s) { if (typeof s != "number" && s != null) {
    let [t, e] = s.split(ie);
    return !e || e === "px" ? parseFloat(t) : null;
} return s || null; }
function wt(s) { return { top: Math.floor(s.top), right: Math.floor(s.right), bottom: Math.floor(s.bottom), left: Math.floor(s.left), width: Math.floor(s.width), height: Math.floor(s.height) }; }
function se(s, t) { return s === t ? !0 : s.isOriginClipped === t.isOriginClipped && s.isOriginOutsideView === t.isOriginOutsideView && s.isOverlayClipped === t.isOverlayClipped && s.isOverlayOutsideView === t.isOverlayOutsideView; }
var oe = [{ originX: "start", originY: "bottom", overlayX: "start", overlayY: "top" }, { originX: "start", originY: "top", overlayX: "start", overlayY: "bottom" }, { originX: "end", originY: "bottom", overlayX: "end", overlayY: "top" }, { originX: "end", originY: "top", overlayX: "end", overlayY: "bottom" }], ne = [{ originX: "end", originY: "top", overlayX: "start", overlayY: "top" }, { originX: "end", originY: "bottom", overlayX: "start", overlayY: "bottom" }, { originX: "start", originY: "top", overlayX: "end", overlayY: "top" }, { originX: "start", originY: "bottom", overlayX: "end", overlayY: "bottom" }], St = "cdk-global-overlay-wrapper";
function Dt(s) { return new N; }
var N = class {
    _overlayRef;
    _cssPosition = "static";
    _topOffset = "";
    ...
    _height = "";
    _isDisposed = !1;
    attach(t) { let e = t.getConfig(); this._overlayRef = t, this._width && !e.width && t.updateSize({ width: this._width }), this._height && !e.height && t.updateSize({ height: this._height }), t.hostElement.classList.add(St), this._isDisposed = !1; }
    ...
    apply() { if (!this._overlayRef || !this._overlayRef.hasAttached())
        return; let t = this._overlayRef.overlayElement.style, e = this._overlayRef.hostElement.style, i = this._overlayRef.getConfig(), { width: o, height: n, maxWidth: r, maxHeight: a } = i, h = (o === "100%" || o === "100vw") && (!r || r === "100%" || r === "100vw"), d = (n === "100%" || n === "100vh") && (!a || a === "100%" || a === "100vh"), l = this._xPosition, c = this._xOffset, u = this._overlayRef.getConfig().direction === "rtl", y = "", g = "", v = ""; h ? v = "flex-start" : l === "center" ? (v = "center", u ? g = c : y = c) : u ? l === "left" || l === "end" ? (v = "flex-end", y = c) : (l === "right" || l === "start") && (v = "flex-start", g = c) : l === "left" || l === "start" ? (v = "flex-start", y = c) : (l === "right" || l === "end") && (v = "flex-end", g = c), t.position = this._cssPosition, t.marginLeft = h ? "0" : y, t.marginTop = d ? "0" : this._topOffset, t.marginBottom = this._bottomOffset, t.marginRight = h ? "0" : g, e.justifyContent = v, e.alignItems = d ? "flex-start" : this._alignItems; }
    dispose() { if (this._isDisposed || !this._overlayRef)
        return; let t = this._overlayRef.overlayElement.style, e = this._overlayRef.hostElement, i = e.style; e.classList.remove(St), i.justifyContent = i.alignItems = t.marginTop = t.marginBottom = t.marginLeft = t.marginRight = t.position = "", this._overlayRef = null, this._isDisposed = !0; }
}, Mt = (() => { class s {
    _injector = p(R);
    constructor() { }
    global() { return Dt(); }
    flexibleConnectedTo(e) { return st(this._injector, e); }
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275prov = f.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })(), ot = new tt("OVERLAY_DEFAULT_CONFIG");
function nt(s, t) { s.get(H).load(Rt); let e = s.get(W), i = s.get(E), o = s.get(ht), n = s.get(zt), r = s.get(j), a = s.get(jt, null, { optional: !0 }) || s.get(Q).createRenderer(null, null), h = new x(t), d = s.get(ot, null, { optional: !0 })?.usePopover ?? !0; h.direction = h.direction || r.value, "showPopover" in i.body ? h.usePopover = t?.usePopover ?? d : h.usePopover = !1; let l = i.createElement("div"), c = i.createElement("div"); l.id = o.getId("cdk-overlay-"), l.classList.add("cdk-overlay-pane"), c.appendChild(l), h.usePopover && (c.setAttribute("popover", "manual"), c.classList.add("cdk-overlay-popover")); let u = h.usePopover ? h.positionStrategy?.getPopoverInsertionPoint?.() : null; return it(u) ? u.after(c) : u?.type === "parent" ? u.element.appendChild(c) : e.getContainerElement().appendChild(c), new I(new ft(l, n, s), c, l, h, s.get(P), s.get(xt), i, s.get(Ut), s.get(Et), t?.disableAnimations ?? s.get(Zt, null, { optional: !0 }) === "NoopAnimations", s.get(Gt), a); }
var Bt = (() => { class s {
    scrollStrategies = p(kt);
    _positionBuilder = p(Mt);
    _injector = p(R);
    constructor() { }
    create(e) { return nt(this._injector, e); }
    position() { return this._positionBuilder; }
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275prov = f.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })(), re = [{ originX: "start", originY: "bottom", overlayX: "start", overlayY: "top" }, { originX: "start", originY: "top", overlayX: "start", overlayY: "bottom" }, { originX: "end", originY: "top", overlayX: "end", overlayY: "bottom" }, { originX: "end", originY: "bottom", overlayX: "end", overlayY: "top" }], ae = new tt("cdk-connected-overlay-scroll-strategy", { providedIn: "root", factory: () => { let s = p(R); return () => et(s); } }), J = (() => { class s {
    elementRef = p(V);
    constructor() { }
    static \u0275fac = function (i) { return new (i || s); };
...
} return s; })(), At = new tt("cdk-connected-overlay-default-config"), le = (() => { class s {
    _dir = p(j, { optional: !0 });
    _injector = p(R);
    _overlayRef;
    _templatePortal;
    ...
    backdropClick = new S;
    positionChange = new S;
    attach = new S;
    detach = new S;
    overlayKeydown = new S;
    overlayOutsideClick = new S;
    constructor() { let e = p(Kt), i = p($t), o = p(At, { optional: !0 }), n = p(ot, { optional: !0 }); this.usePopover = n?.usePopover === !1 ? null : "global", this._templatePortal = new pt(e, i), this.scrollStrategy = this._scrollStrategyFactory(), o && this._assignConfig(o); }
    ...
    _createOverlay() { (!this.positions || !this.positions.length) && (this.positions = re); let e = this._overlayRef = nt(this._injector, this._buildConfig()); this._attachSubscription = e.attachments().subscribe(() => this.attach.emit()), this._detachSubscription = e.detachments().subscribe(() => this.detach.emit()), e.keydownEvents().subscribe(i => { this.overlayKeydown.next(i), i.keyCode === 27 && !this.disableClose && !lt(i) && (i.preventDefault(), this.detachOverlay()); }), this._overlayRef.outsidePointerEvents().subscribe(i => { let o = this._getOriginElement(), n = M(i); (!o || o !== n && !o.contains(n)) && this.overlayOutsideClick.next(i); }); }
    _buildConfig() { let e = this._position = this.positionStrategy || this._createPositionStrategy(), i = new x({ direction: this._dir || "ltr", positionStrategy: e, scrollStrategy: this.scrollStrategy, hasBackdrop: this.hasBackdrop, disposeOnNavigation: this.disposeOnNavigation, usePopover: !!this.usePopover }); return (this.height || this.height === 0) && (i.height = this.height), (this.minWidth || this.minWidth === 0) && (i.minWidth = this.minWidth), (this.minHeight || this.minHeight === 0) && (i.minHeight = this.minHeight), this.backdropClass && (i.backdropClass = this.backdropClass), this.panelClass && (i.panelClass = this.panelClass), i; }
    ...
    _createPositionStrategy() { let e = st(this._injector, this._getOrigin()); return this._updatePositionStrategy(e), e; }
    _getOrigin() { return this.origin instanceof J ? this.origin.elementRef : this.origin; }
    _getOriginElement() { return this.origin instanceof J ? this.origin.elementRef.nativeElement : this.origin instanceof V ? this.origin.nativeElement : typeof Element < "u" && this.origin instanceof Element ? this.origin : null; }
    _getWidth() { return this.width ? this.width : this.matchWidth ? this._getOriginElement()?.getBoundingClientRect?.().width : void 0; }
    attachOverlay() { this._overlayRef || this._createOverlay(); let e = this._overlayRef; e.getConfig().hasBackdrop = this.hasBackdrop, e.updateSize({ width: this._getWidth() }), e.hasAttached() || e.attach(this._templatePortal), this.hasBackdrop ? this._backdropSubscription = e.backdropClick().subscribe(i => this.backdropClick.emit(i)) : this._backdropSubscription.unsubscribe(), this._positionSubscription.unsubscribe(), this.positionChange.observers.length > 0 && (this._positionSubscription = this._position.positionChanges.pipe(Jt(() => this.positionChange.observers.length > 0)).subscribe(i => { this._ngZone.run(() => this.positionChange.emit(i)), this.positionChange.observers.length === 0 && this._positionSubscription.unsubscribe(); })), this.open = !0; }
    ...
    static \u0275inj = f.\u0275\u0275defineInjector({ providers: [Bt], imports: [ct, _t, G, G] });
} return s; })();
import * as Vt from "@angular/core";
import { inject as ce, RendererFactory2 as de } from "@angular/core";
import "@angular/common";
import "rxjs";
import "rxjs/operators";
var je = (() => { class s extends W {
    _renderer = ce(de).createRenderer(null, null);
    ...
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275prov = Vt.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })();
export { Y as BlockScrollStrategy, At as CDK_CONNECTED_OVERLAY_DEFAULT_CONFIG, le as CdkConnectedOverlay, J as CdkOverlayOrigin, Ft as CdkScrollable, L as CloseScrollStrategy, F as ConnectedOverlayPositionChange, $ as ConnectionPositionPair, T as FlexibleConnectedPositionStrategy, je as FullscreenOverlayContainer, N as GlobalPositionStrategy, k as NoopScrollStrategy, ot as OVERLAY_DEFAULT_CONFIG, Bt as Overlay, x as OverlayConfig, W as OverlayContainer, xt as OverlayKeyboardDispatcher, he as OverlayModule, Et as OverlayOutsideClickDispatcher, Mt as OverlayPositionBuilder, I as OverlayRef, X as RepositionScrollStrategy, ne as STANDARD_DROPDOWN_ADJACENT_POSITIONS, oe as STANDARD_DROPDOWN_BELOW_POSITIONS, A as ScrollDispatcher, kt as ScrollStrategyOptions, U as ScrollingVisibility, w as ViewportRuler, Ot as createBlockScrollStrategy, Ct as createCloseScrollStrategy, st as createFlexibleConnectedPositionStrategy, Dt as createGlobalPositionStrategy, Qt as createNoopScrollStrategy, nt as createOverlayRef, et as createRepositionScrollStrategy, ee as validateHorizontalPosition, te as validateVerticalPosition, Xt as \u0275\u0275CdkFixedSizeVirtualScroll, Ht as \u0275\u0275CdkScrollableModule, Tt as \u0275\u0275CdkVirtualForOf, It as \u0275\u0275CdkVirtualScrollViewport, Nt as \u0275\u0275CdkVirtualScrollableElement, Wt as \u0275\u0275CdkVirtualScrollableWindow, Lt as \u0275\u0275Dir };
