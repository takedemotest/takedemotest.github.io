...
var DomRendererFactory2 = class _DomRendererFactory2 {
    ...
    static \u0275fac = function DomRendererFactory2_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _DomRendererFactory2)(i0.\u0275\u0275inject(EventManager), i0.\u0275\u0275inject(_SHARED_STYLES_HOST), i0.\u0275\u0275inject(APP_ID), i0.\u0275\u0275inject(REMOVE_STYLES_ON_COMPONENT_DESTROY), i0.\u0275\u0275inject(DOCUMENT), i0.\u0275\u0275inject(i0.NgZone), i0.\u0275\u0275inject(CSP_NONCE), i0.\u0275\u0275inject(_TracingService, 8));
    };
    static \u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
...
function provideClientHydration(...features) {
    ...
    if (typeof ngDevMode !== "undefined" && ngDevMode) {
        ...
        if (featuresKind.has(HydrationFeatureKind.IncrementalHydration) && featuresKind.has(HydrationFeatureKind.NoIncrementalHydration)) {
            throw new _RuntimeError3(5001, "Configuration error: found both withIncrementalHydration() and withNoIncrementalHydration() in the same call to provideClientHydration(), which is a contradiction.");
        }
    }
...
export { BrowserModule, By, DomSanitizer, EVENT_MANAGER_PLUGINS, EventManager, EventManagerPlugin, HydrationFeatureKind, Meta, REMOVE_STYLES_ON_COMPONENT_DESTROY, Title, VERSION, bootstrapApplication, createApplication, disableDebugTools, enableDebugTools, platformBrowser, provideClientHydration, provideProtractorTestingSupport, withEventReplay, withHttpTransferCacheOptions, withI18nSupport, withIncrementalHydration, withNoHttpTransferCache, withNoIncrementalHydration, BrowserDomAdapter as \u0275BrowserDomAdapter, BrowserGetTestability as \u0275BrowserGetTestability, DomEventsPlugin as \u0275DomEventsPlugin, DomRendererFactory2 as \u0275DomRendererFactory2, DomSanitizerImpl as \u0275DomSanitizerImpl, KeyEventsPlugin as \u0275KeyEventsPlugin, SharedStylesHost as \u0275SharedStylesHost, \u0275getDOM };
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_platform_browser.EFGyfuLMj6-dev.js.map
